...
#i added new words femi
            main_words = [
                ...
                'enigmatic', 'bicycle', 'vietnam', 'sunshine', 'unicorn', 'denmark', 'whirlwind', 'holland', 'house', 'elephant', 'kite', 
                ...
                'hologram', 'astronaut', 'dandelion', 'moonlight', "eloquent", 'butterfly', 'camera', 'gold', 'norway', 'notebook', 'qatar', 
                ...
                'augment', 'algorithm', 'encryption', 'accessories',"resplendent", 'couture', 'haute', 'literate', 'salmon', 'peach', 'cascade'
            ]
