...
[Download Word Game Executable](https://github.com/madefromjames/digital_fortress_python_project/blob/main/word_game.exe). You might need to disable antivirus and ignore any warnings
